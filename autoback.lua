...
getgenv().AutoTeleport = getgenv().AutoTeleport or false
...
local function executeTeleport()
    task.spawn(function()
        ...
        for i = 1, steps do
            if not getgenv().AutoTeleport or not hrp or not hrp.Parent then break end
...
rawMetatable.__namecall = newcclosure(function(self, ...)
    ...
    if getgenv().AutoTeleport and method == "FireServer" and args[1] == "StealEnemyEgg" then
        executeTeleport()
    end
